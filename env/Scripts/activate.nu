...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\User\PycharmProjects\django CRUDE\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\django CRUDE\env\Scripts\deactivate.nu'
